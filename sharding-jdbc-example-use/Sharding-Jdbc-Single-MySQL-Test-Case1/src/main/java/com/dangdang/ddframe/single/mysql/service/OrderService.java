 ...
 * </p>
 */
package com.dangdang.ddframe.single.mysql.service;
...
import com.dangdang.ddframe.single.mysql.dao.OrderRepository;
...
public class OrderService {
	...
	public void batchInsert(Integer size) {
		for (int i = 0; i < size; i++) {
			Order criteria = new Order();
			criteria.setUserId(i);
			criteria.setStatus("INSERT_" + i);
			orderRepository.insert(criteria);
		}
	}
